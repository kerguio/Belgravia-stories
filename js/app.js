...
function onEachFeature(feature, layer) {
  ...
  var html = "<h4>" + name + "</h4><strong>Famous for:</strong> " + fame + "<br><strong>Address:</strong> " + address + '<br><br><h3><a href="' + url + '" target="_blank">Get Google Maps directions</a></h3><br><br>';
